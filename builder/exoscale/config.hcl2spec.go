...
type FlatConfig struct {
	APIEnvironment             *string           `mapstructure:"api_environment" cty:"api_environment"`
	...
	InstanceTemplateVisibility *string           `mapstructure:"instance_template_visibility" cty:"instance_template_visibility"`
