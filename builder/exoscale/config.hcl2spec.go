...
type FlatConfig struct {
	...
	InstanceTemplateVisibility *string           `mapstructure:"instance_template_visibility" cty:"instance_template_visibility" hcl:"instance_template_visibility"`
	...
	SnapshotDownloadPath       *string           `mapstructure:"snapshot_download_path" cty:"snapshot_download_path" hcl:"snapshot_download_path"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"instance_template_visibility": &hcldec.AttrSpec{Name: "instance_template_visibility", Type: cty.String, Required: false},
		...
		"snapshot_download_path":       &hcldec.AttrSpec{Name: "snapshot_download_path", Type: cty.String, Required: false},
